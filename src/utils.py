...
CMAPS = {
    ...
    'ultra': [(0.0, '#05095c'), 
              (0.1, '#0932A4'), (0.2, '#50A4E4'), (0.4, 'white'), 
              (0.5, '#FACF31'), (0.6, '#B85611'), (0.7, '#6C3834'), 
              (0.99, '#00065C'), (1.0, 'black')],
    'ultra2': [(0.0, '#00065C'), 
               (0.05, '#0932A4'), (0.1, '#50A4E4'), (0.2, 'white'), 
               (0.25, '#FACF31'), (0.3, '#B85611'), (0.35, '#6C3834'), 
               (0.5, '#00065C'), 
               (0.55, '#0932A4'), (0.6, '#50A4E4'), (0.7, 'white'), 
               (0.75, '#FACF31'), (0.8, '#B85611'), (0.85, '#6C3834'), 
               (0.99, '#00065C'), (1.0, 'black')],
...
def set_plot_style(axis_lines=False, font=None):
    ...
    if font:
        is_installed = [f for f in font_manager.fontManager.ttflist
                        if font in f.name]
...
def make_gif(
    ...
    if pause:
        image_files = (image_files[:1] * pause 
                       + image_files 
                       + image_files[-1:] * pause)
